...
<h3>Tambah Barang Thrift</h3>

<div class="form-container">
    <form action="?page=addBarang&action=simpan" method="post">
        <label for="nama_barang">Nama Barang</label>
        <input type="text" id="nama_barang" name="nama_barang" placeholder="Masukkan Nama Barang" required>

        <label for="harga_barang">Harga Barang</label>
        <input type="text" id="harga_barang" name="harga_barang" placeholder="Masukkan Harga Barang" required>

        <label for="warna_barang">Warna Barang</label>
        <input type="text" id="warna_barang" name="warna_barang" placeholder="Masukkan Warna Barang" required>
        ...
        <div class="form-btn">
            <input type="submit" value="Simpan Barang" class="btn-submit">
